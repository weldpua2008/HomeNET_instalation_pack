...
Section /o "Перезаписать список Хабов" Section10
	...
	;		File "homenet_tool\Favorites.xml"
		...
		true_section10:	
		  ...
		  Goto next_section10
		false_section10:
			MessageBox MB_OK "Текущий список хабов: Skyhome: hub.skyhome (10.200.25.9), Homenet: fobos.homenet:4012 (10.10.10.253:4012), hub.homenet ( 10.24.0.3). Если он у Вас другой - добавьте их. Внимание ИП адресс может меняться."
		next_section10:

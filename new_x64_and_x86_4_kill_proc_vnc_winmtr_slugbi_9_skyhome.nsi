...
Section /o  "Windows x86 32bit" Section1
	...
	;сайты
	CreateShortCut "$SMPROGRAMS\Skyhome\Сайт Skyhome.lnk" "http://skyhome/" "" "$INSTDIR\Skyhome\home.ico"
	CreateShortCut "$DESKTOP\Сайт Skyhome.lnk" "http://skyhome/" "" "$INSTDIR\Skyhome\home.ico"
...
Section /o "Перезаписать список Хабов" Section10
	...
	;		File "Skyhome_tool\Favorites.xml"
		...
		true_section10:	
		  ...
		  Goto next_section10
		false_section10:
			MessageBox MB_OK "Текущий список хабов: Skyhome: 10.200.25.9, Хоумнет: hub.Skyhome, hub.skyhome. Если он у Вас другой - добавьте их."
		next_section10:

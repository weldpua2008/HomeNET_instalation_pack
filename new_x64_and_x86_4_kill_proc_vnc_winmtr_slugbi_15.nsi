...
Section /o "Перезаписать список Хабов" Section10
	...
	;		File "homenet_tool\Favorites.xml"
		...
		true_section10:	
			...
			MessageBox MB_OK "Текущий список хабов: Skyhome: hub.skyhome.homenet (10.200.25.9), Homenet: fobos.homenet:4012 (10.10.10.253:4012), hub.homenet ( 10.24.0.3). Если он у Вас другой - добавьте их. Внимание ИП адресс может меняться."
		  Goto next_section10
		false_section10:
			MessageBox MB_OK "Текущий список хабов: Skyhome: hub.skyhome.homenet (10.200.25.9), Homenet: fobos.homenet:4012 (10.10.10.253:4012), hub.homenet ( 10.24.0.3). Если он у Вас другой - добавьте их. Внимание ИП адресс может меняться."
		next_section10:
...
!insertmacro MUI_FUNCTION_DESCRIPTION_BEGIN
	...
	!insertmacro MUI_DESCRIPTION_TEXT ${Section3} "Включить службу DHCP-клиент и DNS-клиент (DHCP Client)"
!insertmacro MUI_DESCRIPTION_TEXT ${Section11} "IPTV бета версия для Хоумнета"
...
Function .onInit
	...
	;enable DHCP enable DNS client by default
	...
	;	false_section10:
	;		SectionSetFlags ${Section10} 0
	;		MessageBox MB_OK "Текущий список хабов: Skyhome: 10.200.25.9, Homenet: hub.homenet, hub.skyhome. Если он у Вас другой - добавьте их."
	;	next_section10:
	;	
